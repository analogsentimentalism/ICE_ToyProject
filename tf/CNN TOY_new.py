...
for train_index, test_index in kf.split(x):
    ...
    file_path = "test_toytoy_model"+str(k_no)+".hdf5"
...
#%%
model.load_weights("test_toytoy_model"+str(value_index)+".hdf5")
best_model = model
...
#Model Save
best_model.save_weights('test_toytoy_model.weights.h5')
best_model.save('test_toytoy_model_keras.h5')
